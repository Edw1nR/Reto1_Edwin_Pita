...
public class Formulario_Empleado extends javax.swing.JFrame {
    ...
    private void ACEPTARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ACEPTARActionPerformed
        ...
        String queryCrearEmpleado = "INSERT INTO `empleados`(`nombreEmp`, `apellidos`, `tipoDocumento`, `documento`, `correo`) VALUES ('"+ NOMBRE +"','"+ Apellidos +"','"+ TipoDocumento +"','"+ Documento +"','"+ Correo +"',)";
    ...
    JOptionPane.showMessageDialog(this, "NO SE PUDO CREAR EL EMPLEADO", "NUEVO EMPLEADO", JOptionPane.error);
    }
    /**
